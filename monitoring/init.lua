...
if not monitoring.settings.builtin_disable then
  ...
  dofile(MP.."/builtin/add_entity.lua")
  dofile(MP.."/builtin/add_item.lua")
  dofile(MP.."/builtin/add_node.lua")
  ...
  dofile(MP.."/builtin/get_node.lua")
  dofile(MP.."/builtin/get_voxel_manip.lua")
  dofile(MP.."/builtin/get_objects_inside_radius.lua")
  ...
  dofile(MP.."/builtin/load_area.lua")
  ...
  dofile(MP.."/builtin/set_node.lua")
  dofile(MP.."/builtin/swap_node.lua")
